...
int test2(int a, int b, int c, int d, int i) {
  // should be parallelizable into a vector add
...
int test3(int a, int b, int c, int d, int i) {
  // should be parallelizable into a vector add
  // <e, f, g, h> = <a, b, c, d> + <A[i], A[i+2], A[i+1], A[i+10]>
  int e = a + A[i];
  int f = b + A[i + 2];
  int g = c + A[i + 1];
  int h = d + A[i + 10];
...
void test4(int a, int b, int c, int d, int i) {
  // should be parallelizable into a vector add
...
void test5(int a, int b, int c, int d, int i) {
  // should be parallelizable into a vector add
